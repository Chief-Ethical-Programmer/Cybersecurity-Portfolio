...
- [VMware Setup](#vmware-setup)
  - [Configuring the Network Interfaces](#1-configuring-the-network-interfaces)
  - [VM Setup](#2-vm-setup)
- [pfSense Setup](#pfsense-setup)
  - [Installing pfSense](#1-installing-the-pfsense)
  - [Web GUI](#2-web-gui)
  - [WAN & DMZ Interfaces Setup](#3-wan--dmz-interfaces-setup)
  - [DHCP Server](#4-dhcp-server)
  - [Firewall Rules](#5-firewall-rules)
- [Suricata Setup](#suricata-setup)
  - [DMZ Interface Settings](#1-dmz-interface-settings)
  - [Threat Detection](#2-threat-detection)
  - [Start the Instance](#3-start-the-instance)
- [AWS (VPS) Setup](#aws-vps-setup)
  - [Create the EC2 Instance](#1-create-the-ec2-instance)
- [WireGuard Setup](#wireguard-setup)
  - [Installing WireGuard](#1-installing-wireguard)
  - [Generating Key Pairs](#2-generating-key-pairs)
  - [Configuring WireGuard](#3-configuring-of-wireguard)
  - [Starting and Persistence](#4-starting-and-persistance)
- [Honeypot Setup](#honeypot-setup)
  - [Cowrie](#1-cowrie)
    - [Installation on EC2](#11-installation-on-ec2)
    - [Configuring Cowrie](#12-configuring-cowrie)
    - [Redirect SSH to Cowrie](#13-redirect-ssh-to-cowrie)
    - [Start Cowrie](#14-start-cowrie)
  - [OpenCanary](#2-opencanary)
    - [Install Dependencies](#21-install-dependencies)
    - [Create an Unprivileged User](#22-create-a-dedicated-unprivileged-system-user)
    - [Set Up Virtual Environment](#23-set-up-the-virtual-environment-and-install-opencanary)
    - [Generate and Edit Configuration](#24-generate-and-edit-the-configuration)
    - [Grant Privileged Port Binding](#25-grant-the-priviledge-port-binding)
    - [Start OpenCanary](#26-start-opencanary)
- [Wazuh Setup](#wazuh-setup)
  - [Wazuh Manager Installation](#1-installing-the-wazuh-manager-in-on-prem-vm)
  - [Wazuh Agent Installation on EC2](#2-wazuh-agent-installation-on-ec2)
